...
// CommercialTopic is the IAG bus topic CRM subscribes to.
const CommercialTopic = "iag.commercial"

// ProcessedEventsTable is the dedupe table name.
const ProcessedEventsTable = "crm_processed_events"

// Options bundles everything needed to construct the CRM consumer.
type Options struct {
	Brokers  []string
	GroupID  string
	DLQTopic string
...
// New builds a platformevents.Consumer wired to CRM's handler.
